...
The repository includes a full-stack Flask web application in the [`terrystops-ai/`](terrystops-ai/) directory. It features:

- **Real-time prediction** via a multi-step form and REST API
- **SHAP / LIME explainability** for model transparency
- **Bias audit dashboard** measuring fairness across demographics
- **Interactive analytics** with Plotly charts

See [terrystops-ai/README.md](terrystops-ai/README.md) for setup and usage instructions.

## For More Information
See the full analysis in the [Jupyter Notebook](https://github.com/paulmwangi/Terry--Traffic--Stops-Prediction/blob/main/Terry-Stops-Classification.ipynb) or review the [presentation](https://github.com/paulmwangi/Terry--Traffic--Stops-Prediction/blob/main/PRESENTATION.md).

For an in-depth explanation of every method, algorithm, and design decision used in the ML pipeline, see [METHODOLOGY.md](METHODOLOGY.md).
## Repository Structure

* ├── .ipynb_checkpoints
* ├── images
* ├── terrystops-ai/          ← Flask web app with ML pipeline
* ├── .gitignore
* ├── README.md
* ├── Terry-Stops-Classification.ipynb
* ├── Terry_Stops.csv
* └── presentation.pdf
